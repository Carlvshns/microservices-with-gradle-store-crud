package dev.carlvs.shopping.endpoint;
...
import dev.carlvs.shopping.error.ErrorMessage;
import dev.carlvs.shopping.services.InvoiceService;
...
public class InvoiceController {
    ...
    public ResponseEntity<Invoice> deleteInvoice(@PathVariable("id") long id) {
        ...
        invoice = invoiceService.setStateDeletedInvoice(invoice);
        return ResponseEntity.ok(invoice);
    }
}

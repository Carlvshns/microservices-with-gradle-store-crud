package dev.carlvs.customer.endpoint;
...
import dev.carlvs.customer.error.ErrorMessage;
import dev.carlvs.customer.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<Customer> deleteCustomer(@PathVariable("id") long id) {
        ...
        customer = customerService.setDeletedStateCustomer(customer);
        return  ResponseEntity.ok(customer);
    }
}
